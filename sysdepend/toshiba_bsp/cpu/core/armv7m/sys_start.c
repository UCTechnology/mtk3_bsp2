...
#if defined(MTKBSP_TOSHIBA_BSP) && defined(MTKBSP_CPU_CORE_ARMV7M)

/*
 *	sys_start.c (TOSHIBA BSP & ARMv7-M)
...
#endif	/* defined(MTKBSP_TOSHIBA_BSP) && defined(MTKBSP_CPU_CORE_ARMV7M) */